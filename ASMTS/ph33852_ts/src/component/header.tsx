...
const Header = () => {
  return (
    <>
      <header className="bg-white fixed top-0 left-0 right-0 z-50 border-b border-black-500">
        <div className="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
          ...
          {/* Menu */}
          <div className="flex flex-1 items-center mt-2 justify-end md:justify-between">
            <nav aria-label="Global" className="hidden md:block mt-2">
              <ul className="flex items-center gap-6 text-sm ">
                <li>
                  <NavLink
                    className="text-gray-500 transition hover:text-gray-500/75 font-semibold no-underline"
                    to="/"
                  >
                    {" "}
                    Home{" "}
            ...
            <div className="flex items-center gap-4">
              <div className="sm:flex sm:gap-2">
                <a
                  className="no-underline hidden rounded-md px-3 py-2.5 text-[14px] font-medium text-gray-600 transition hover:text-red-700 sm:block"
                  href="#"
                >
                  Đăng ký
                </a>
