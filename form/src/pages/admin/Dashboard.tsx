...
const Dashboard = ({ products }: Props) => {
  ...
  return (
    <>
      ...
      <Link className='no-underline mb-10 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded' to='/admin/add'>
        Add new product
      </Link>
      ...
      <div className='overflow-x-auto mt-10'>
        ...
        <table className='min-w-full divide-y-2 divide-gray-200 bg-white text-sm'>
          ...
          <tbody className='divide-y divide-gray-200'>
              ...
              <tr key={item.id}>
                <td className='whitespace-nowrap px-4 py-2 font-medium text-gray-900 text-center'></td>
                <td className='whitespace-nowrap px-4 py-2 text-gray-700 text-center'></td>
       
                <td className='whitespace-nowrap px-4 py-2 text-gray-700 flex justify-center items-center'>
                  <img className='max-w-full h-auto' width={140} src={} alt={} />
                </td>

                <td className=' px-4 py-2 text-gray-900'>desc</td>
